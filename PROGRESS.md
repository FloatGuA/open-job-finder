...
|----------|---------------------------------|
| 整体状态 | 进行中                          |
| 最后更新 | 2026-08-19（v2.28.0 计划 A 站点手册地基交付；spec/计划 A 已定稿，**计划 B 三节点重构未开始**） |
| 当前版本 | 2.28.0                         |
...
审批页现在只有标题和类别。人在这一页要决定"投不投"，但**两头都缺信息**：

| 要决定的 | 看不到的 |
|---|---|
| 这岗位值不值得投 | **JD**（计划 C 原本就排了「JD 进审批页」） |
| 投出去会发生什么 | **会发哪一份简历** / matched 还是兜底 / PDF 就绪没有 |
